...
)
{
	...
	if (pData == nullptr)
	{
		...
		throw RainException("Load texture \"%s\" failed. Reason : [%s]", Filename.c_str(), pFailReason);
	}
...
{
	throw RainException("Texture::GetAverage() is not implemented!");
}

Color3f Texture::GetMinimum() const
{
	throw RainException("Texture::GetMinimum() is not implemented!");
}

Color3f Texture::GetMaximum() const
{
	throw RainException("Texture::GetMaximum() is not implemented!");
}

Vector3i Texture::GetDimension() const
{
	throw RainException("Texture::GetDimension() is not implemented!");
}

bool Texture::IsConstant() const
{
	throw RainException("Texture::IsConstant() is not implemented!");
}

bool Texture::IsMonochromatic() const
{
	throw RainException("Texture::IsMonochromatic() is not implemented!");
}
